...
SC.State = SC.Object.extend(
  ...
  */
  ...
  /**
    ...
    Recursively looks up the current substates of itself and its parents
    to find the best current state in statecharts that have concurrent parts
  */
  handleTriggeredRoute: function(context) {
    ...
    currentState = nextParentState.get('currentSubstates')[0];

    if(this !== currentState) {
      this.get('statechart').gotoState(this, currentState, context);
    }
  },
